...
<div class="container" style="max-width:800px; margin-top:100px;">
    <h2 style="text-align:center; color:#0e64ba;">My Booking Details</h2>
  ...
  @endif
   <div class="booking-card">
      ...
      <div class="booking-header">
        ...
        <span class="status {{ \Carbon\Carbon::parse($booking->date)->isFuture() ? 'upcoming' : 'past' }}">
          {{ \Carbon\Carbon::parse($booking->date)->isFuture() ? 'Upcoming' : 'Past' }}
        </span>
      </div>
      ...
      <div class="booking-grid">
        ...
        <div><strong>Event Date:</strong> {{ $booking->date }}</div>
